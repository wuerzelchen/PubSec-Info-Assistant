...
export const TagPickerInline = ({ allowNewTags, onSelectedTagsChange, preSelectedTags, hide }: Props) => {
  ...
  const pickerSuggestionsProps: IBasePickerSuggestionsProps = {
    suggestionsHeaderText: t('existingTags'),
    noResultsFoundText: allowAddNew ? t('pressEnterToAdd') : t('noMatchingTag'),
  };
    ...
    <div className={hide ? styles.hide : styles.tagArea}>
      <div className={styles.tagSelection}>
        <div className={allowAddNew ? styles.rootClass : styles.rootClassFilter}>
          <label htmlFor={pickerId}>{t('tags')}</label>
          <TagPicker
            className={styles.tagPicker}
            removeButtonAriaLabel={t('remove')}
            selectionAriaLabel={t('existingTags')}
        ...
        <TooltipHost content={allowAddNew ? t('tagsToAppend') : t('tagsToFilter')}
          styles={hostStyles}
          id={tooltipId}>
